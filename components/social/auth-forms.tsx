...
// Phone-number entry. The visitor picks their country code, types the rest of
// their number and taps Injira — they are signed in straight away. A new number
// is registered automatically. No codes, no waiting: nobody can get stuck.
